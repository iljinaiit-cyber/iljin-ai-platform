...
export function FeedbackBoard() {
  ...
  return <div className="view-stack feedback-board">
    <div className="page-heading"><div><span className="section-kicker">USER VOICE</span><h1 className="sr-only">{"\uC0AC\uC6A9\uC790 \uC758\uACAC"}</h1><p>{"\uC11C\uBE44\uC2A4\uC5D0 \uB300\uD55C \uC81C\uC548\uACFC \uC758\uACAC\uC744 \uB0A8겨 \uC8FC\uC138\uC694."}</p></div><span className="feedback-count">{text.all} {pagination.total}{"\uAC74"}</span></div>
