/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2c8e9b09dcbe1984191f6a67655866d6)
...
interface __BaseEnv_Env {
	...
	EDGE_RATE_LIMIT_REQUIRED: "false";
	RESEND_FROM_EMAIL: "ILJIN AI Works <no-reply@notify.iljin.com>";
	APP_ENV: "preview" | "production";
	COST_PROFILE: "test" | "prod";
	MAX_SENSITIVITY: "public" | "confidential";
	MAX_EGRESS_SENSITIVITY: "public" | "internal";
	DISABLED_AI_KINDS: "image_gen,tts" | "image_gen";
	DAILY_BUDGET_PER_USER: "50" | "400";
	DAILY_BUDGET_PER_TENANT: "200" | "5000";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_AI_PREMIUM_MODEL" | "CLOUDFLARE_AI_GATEWAY_ID" | "CLOUDFLARE_EMBED_MODEL" | "CLOUDFLARE_RERANK_MODEL" | "CLOUD_VLM_MODEL" | "CLOUDFLARE_TTS_MODEL" | "CLOUDFLARE_IMAGE_MODEL" | "TRUSTED_IDENTITY_MODE" | "TRUSTED_IDENTITY_HOSTS" | "EDGE_RATE_LIMIT_REQUIRED" | "RESEND_FROM_EMAIL" | "APP_ENV" | "COST_PROFILE" | "MAX_SENSITIVITY" | "MAX_EGRESS_SENSITIVITY" | "DISABLED_AI_KINDS" | "DAILY_BUDGET_PER_USER" | "DAILY_BUDGET_PER_TENANT" | "LOCAL_LLM_BASE_URL" | "LOCAL_LLM_MODEL" | "LOCAL_LLM_API_KEY" | "LOCAL_LLM_ACCESS_CLIENT_ID" | "LOCAL_LLM_ACCESS_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "LOCAL_EMBED_MODEL" | "BRAVE_SEARCH_API_KEY" | "LLM_TIMEOUT_MS" | "LOCAL_LLM_TIMEOUT_MS" | "CLOUDFLARE_AI_MODEL" | "DEFAULT_TENANT_ID" | "DEFAULT_DEPARTMENT" | "DEFAULT_USER_ROLE" | "ALLOW_DEV_IDENTITY" | "ADMIN_EMAILS">> {}
}
